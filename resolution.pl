...
:-chr_constraint a/0,a/1,b/0,b/1,c/0,c/1,d/0,d/1,e/0,e/1,c(X)/0,c(X)/1,start/0,conflictdone/0,fire/0,id/1,history/1,match/2,match/3.
...
start, a(ID1), b(ID2), c(ID3) ==> member(2,[1,2])| match(r1,4,[ID1,ID2,ID3]).
start, a(ID1), b(ID2), d(ID3) ==> member(2,[1,2])| match(r2,7,[ID1,ID2,ID3]).
start, e(ID1) ==> member(2,[1,2])| match(r3,4,[ID1]).
start, c(X) ==>  match(r4,2,[]).
...
c(X),history(L),fire,match(r4,_,[]) <=> print('fired r4'),nl,true,history([(r4,[])|L]),start.
